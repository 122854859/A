        ...
        function uploadImage(fileDom) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        $(fileDom).parent('.details_picList_fileUpload').before("<li><img src='${pageContext.request.contextPath}/res/images/item/categoryPicture/" + data.fileName + "' id='pic_category'  height='150px'/></li>").css("display", "none");
                    } else {
                        alert("图片上传异常！");
                    }
                },
...
<div class="details_div">
    ...
    <ul class="details_picList" id="category_list">
        <c:if test="${requestScope.category.category_image_src != null}">
            <li>
                <img src="${pageContext.request.contextPath}/res/images/item/categoryPicture/${requestScope.category.category_image_src}"
                    id="pic_category"  height="150px"/></li>
        </c:if>
