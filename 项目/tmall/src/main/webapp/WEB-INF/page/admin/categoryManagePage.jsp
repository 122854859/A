...
<head>
    <script>
                ...
                success: function (data) {
                    ...
                    if(data.categoryList.length > 0) {
                        for (var i = 0; i < data.categoryList.length; i++) {
                            ...
                            //显示分类数据
                            tbody.append("<tr><td><input type='checkbox' class='cbx_select' id='cbx_category_select_" + category_id + "'><label for='cbx_category_select_" + category_id + "'></label></td>" +
                                "<td title='" + category_name + "'>" + category_name + "</td>" +
                                "<td><span class='td_special'><a href='javascript:void(0)' onclick='getChildPage(this)' class='editBtn'>修改</a></span>" +
        ...
        function deleteRow(obj){
            var id = $(obj).parents("tr").find(".category_id").text();
            console.log(id)
            var msg = "确定要删除吗？！";
            if (confirm(msg)==true){
                $.get("admin/category/delete/"+id,function(msg){
                    if(msg == 1){
                        alert("删除成功！")
                        getData($(this), "admin/category/0/10", dataList);
                    }else{
...
<%--                    <a href="javascript:void(0)" onclick="getChildPage(this)">详情</a></span>--%>
                    <span class="td_special" >
                    <a href="javascript:void(0)" onclick="getChildPage(this)" class="editBtn">修改</a></span>
                    <span class="td_special" >
                    <a href="javascript:void(0)" onclick="deleteRow(this)">删除</a></span>
                </td>
