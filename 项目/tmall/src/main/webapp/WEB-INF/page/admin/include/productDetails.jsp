...
<div class="details_div">
    ...
    <div class="frm_div_last">
        <label class="frm_label text_info" id="lbl_product_price" for="input_product_price">库存</label>
        <input class="frm_input details_unit"  id="count" type="text"
               maxlength="10" value="${requestScope.product.count}"/>
