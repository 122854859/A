...
<nav>
    ...
    <div class="header">
        <div id="mallLogo">
            <h2 style="float: left;width: 240px;height: 45px; color: red;line-height: 45px;font-family: cursive;
font-weight: 700;">社区提供生鲜的平台</h2>
        </div>
    ...
    <c:choose>
        <c:when test="${fn:length(requestScope.orderItemList)<=0}">
            ...
            <div id="empty">
                ...
                <ul>
                    <li>看看<a href="${pageContext.request.contextPath}/order">我的订单</a></li>
                </ul>
            </div>
        </c:when>
        <c:otherwise>
