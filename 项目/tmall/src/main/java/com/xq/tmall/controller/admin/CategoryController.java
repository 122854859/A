...
public class CategoryController extends BaseController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "admin/category/delete/{category_id}", method = RequestMethod.GET)
    public Integer updateCategory(@PathVariable Integer category_id){
        try {
            Integer res = categoryService.delete(category_id);
            return res;
        } catch (Exception e) {
            e.printStackTrace();
            return 2;
