...
public class ProductOrderItemServiceImpl implements ProductOrderItemService{
    ...
    public List<ProductOrderItem> getProductId(){
        List<ProductOrderItem> list = productOrderItemMapper.getProductId();
        for (ProductOrderItem po:list) {
            System.out.println(po.getProductOrderItem_id() +"=======33==========");
            Product product = productMapper.selectOne(po.getProductOrderItem_id());
            System.out.println(product);
            po.setProductOrderItem_product(product);
        }
        return list;
    }
}
