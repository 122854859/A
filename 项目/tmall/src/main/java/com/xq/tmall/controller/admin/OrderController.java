...
public class OrderController extends BaseController{
     ...
     */
    @ResponseBody
    @RequestMapping(value = "order/getProductId", method = RequestMethod.GET)
    public List<ProductOrderItem> getProductId(){
        List<ProductOrderItem> list = productOrderItemService.getProductId();
        return list;
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "order/getSaleMoney", method = RequestMethod.GET)
    public List<ProductOrder> getSaleMoney(){
        List<ProductOrder> list = productOrderService.getSaleMoney();
        return list;
    }
