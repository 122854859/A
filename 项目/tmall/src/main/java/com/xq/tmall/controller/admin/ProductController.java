...
public class ProductController extends BaseController{
     ...
     */
    @ResponseBody
    @RequestMapping(value = "admin/product/delete/{product_id}", method = RequestMethod.GET)
    public Integer updateCategory(@PathVariable Integer product_id){
       try {
            Integer res = productService.delete(product_id);
            return res;
        } catch (Exception e) {
            e.printStackTrace();
            return 2;
