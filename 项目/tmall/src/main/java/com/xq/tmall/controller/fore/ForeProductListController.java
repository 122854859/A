...
public class ForeProductListController extends BaseController {
    ...
    public String goToPage(HttpSession session, Map<String, Object> map, HttpServletRequest request,
        ...
        //product_name = new String(product_name.getBytes("UTF-8"), "GBK");
    ...
    public String searchProduct(HttpSession session, Map<String, Object> map, HttpServletRequest request,
