...
public class UserController extends BaseController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "admin/user/delete/{user_id}", method = RequestMethod.GET)
    public Integer updateCategory(@PathVariable Integer user_id){
        try {
            Integer res = userService.delete(user_id);
            return res;
        } catch (Exception e) {
            e.printStackTrace();
            return 2;
